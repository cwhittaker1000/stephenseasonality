...
features_df <- readRDS(file = here::here("data", "systematic_review_results", "metadata_and_time_series_features.rds"))
cluster_output <- readRDS(file = here::here("data", "systematic_review_results", "cluster_membership.rds"))
