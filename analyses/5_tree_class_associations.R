...
# This pretty much matches the show_best results above, so fine
...
# this rmse calculation is NOT the same as reported in show_best exactly. But that's
...
sum(pred == order_raw_pred_best_hyp$peaks)/length(order_raw_pred_best_hyp$peaks)
