...
#                  rep(density_end, 365 * 35))

# Running Model - No IRS
...
set_up_model3 <- create_r_model_epidemic(odin_model_path = "models/odin_model_seasonality_new_IRS.R", # model file
                                         ...
                                         ITN_interval = 10000,
                                         itn_cov = 0)
set_up_model3 <- set_up_model3$generator(user = set_up_model3$state, use_dde = TRUE)
...
set_up_model4 <- create_r_model_epidemic(odin_model_path = "models/odin_model_seasonality_new_IRS.R", # model file
                                         ...
                                         ITN_interval = 10000,
                                         itn_cov = 0)
set_up_model4 <- set_up_model4$generator(user = set_up_model4$state, use_dde = TRUE)
...
set_up_model5 <- create_r_model_epidemic(odin_model_path = "models/odin_model_seasonality.R", # model file
                                         ...
                                         irs_cov = 0.8,
                                         itn_cov = 0)
set_up_model5 <- set_up_model5$generator(user = set_up_model5$state, use_dde = TRUE)
...
# par(mfrow = c(1, 3))
# plot(model_ran$prev, type = "l", ylim = c(0, max(model_ran$prev)))
# lines(model_ran2$prev, type = "l", col = "red")
# lines(model_ran3$prev, type = "l", col = "blue")
# lines(model_ran4$prev, type = "l", col = "purple")
# 
# plot(model_ran$Incidence, type = "l", ylim = c(0, max(model_ran$Incidence)))
# lines(model_ran2$Incidence, type = "l", col = "red")
# lines(model_ran3$Incidence, type = "l", col = "blue")
# lines(model_ran4$Incidence, type = "l", col = "purple")
# 
# plot(model_ran$Incidence[((years - 2) * 365):length(model_ran$Incidence)], type = "l", ylim = c(0, max(model_ran$Incidence[((years - 2) * 365):length(model_ran$Incidence)])))
# lines(model_ran2$Incidence[((years - 2) * 365):length(model_ran$Incidence)], type = "l", col = "red")
# lines(model_ran3$Incidence[((years - 2) * 365):length(model_ran$Incidence)], type = "l", col = "blue")
# lines(model_ran4$Incidence[((years - 2) * 365):length(model_ran$Incidence)], type = "l", col = "purple")
