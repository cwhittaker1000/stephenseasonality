...
reduce_betaa[1:time_length] <- user()
dim(reduce_betaa) <- time_length

betaa <- (0.5*PL/dPL) * reduce_betaa[as.integer(t)]
...
# New parameters and formulation from https://www.nature.com/articles/s41467-018-07357-w
